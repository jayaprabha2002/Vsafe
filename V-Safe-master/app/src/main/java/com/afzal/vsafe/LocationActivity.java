...
public class LocationActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener{
    ...
    TextView tvlats,tvlongs;
    Button bt;
    String con1,con2;
    boolean hasGps,hasNetwork;
    double lati,longi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvlats = findViewById(R.id.tvlat);
        tvlongs = findViewById(R.id.tvlong);
        bt = findViewById(R.id.stoptrack);
...
;       bt.setOnClickListener(new View.OnClickListener() {
    ...
    public void onLocationChanged(@NonNull Location location) {
        ...
        tvlats.setText(String.valueOf(location.getLatitude()));
        tvlongs.setText(String.valueOf(location.getLongitude() ));
        Toast.makeText(this, msg, Toast.LENGTH_SHORT).show();
        // You can now create a LatLng Object for use with map

        String no1 = "9841119294";
        String no2 = "9841340847";
